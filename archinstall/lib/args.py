...
from archinstall.lib.models.bootloader import Bootloader, GrubConfiguration
...
class ArchConfig:
	...
	def from_config(cls, args_config: dict[str, Any], args: Arguments) -> 'ArchConfig':
		...
		# Swap configuration is now handled in disk menu
		# arch_config.swap will be set by the disk configuration menu if needed
